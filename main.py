...
class MainThread(QThread):
    ...
    def takecommand(self):
        ...
        with sr.Microphone() as source:#voice capture karava mate microphone ne source tarike lidhel chhe 
            ...
            audio=r.listen(source,phrase_time_limit=8)#listen function thi sabhadave chhe 

        try:
            print("recognizing...")# khabar pade ke recognize thay chhe
            self.query=r.recognize_google(audio,language='en-in')#speech recognition packege duwara (speech recognition.recognize.recognize_google) function thi audio ane language aapiye chhe
        ...
        # if 1:
            ...
            if "open youtube" in self.query:
                ...
                webbrowser.open("https://www.youtube.com//?feature=ytca")#webbrowser package ni madad thi open (url) open ni andar jeno url hoy te ni website khule chhe  
                    ...
                    speak("we have very low power to continue our work, please connect to your charging the system will be sutdown very soon") 
            ...
            #open command prompt
            elif "open command" in self.query or "open command prompt" in self.query:
                speak("okey sir, open command prompt")
                time.sleep(1)
                os.system("start cmd")
            
            #open command prompt
            elif "open c m d" in self.query:
                speak("okey sir, open command prompt")
                os.system("start cmd")       
            ...
            #sutdown window
            elif "shut down window" in self.query:
                speak("system is shut down")
                os.system("shutdown /s /t 5")
            ...
            #restart the system 
            elif "restart the window" in self.query:
                speak("system is shut down")
                os.system("shutdown /r /t 5")
            ...
            elif "open photos" in self.query:
            ...
            #any profile open 
            elif"instagram profile" in self.query or "check instagram profile" in self.query:
            ...
            elif"open instagram profile" in self.query or "profile instagram" in self.query:
                speak("sir please enter the user name correctly")
                name =input("enter user name here:- ")
                webbrowser.open(f"www.instagram.com/{name}")
                speak(f"sir here is the profile of the user {name}")
            ...
            elif "search current temperature" in self.query:
            ...
            elif "internet speed" in self.query or "check internet speed" in self.query:
            ...
            elif "please tell me about this laptop properties" in self.query or "properties of this laptop" in self.query:
            ...
            elif "how much power left" in self.query or "how much power we have" in self.query or "how much battery left" in self.query or "power" in self.query or"battery" in self.query:
                battery =psutil.sensors_battery()
                percentage=battery.percent
                speak(f"sir our system have {percentage}% percent of battery")
                if percentage >=75:
                    speak("we have enough power to continue our work")
                elif percentage >=40 and percentage <=75:
                    speak("we should connect our system to charging point to charge our battery")
                elif percentage >=15 and percentage <=30:
                    speak("we doen't have enough power to work ,please connect to your charging")
                elif percentage <=15:
                    speak("we have very low power to continue our work, please connect to your charging the system will be sutdown very soon") 
            ...
            elif 'mute' in self.query or 'unmute' in self.query or 'volume mute' in self.query or 'volume unmute' in self.query:
            ...
            #     kit.sendmessage("mobile number","message",2,25)
...
class Main(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.toolButton_2.clicked.connect(self.startTask)
        self.ui.toolButton_3.clicked.connect(self.close)
 
    def startTask(self):
        self.ui.movie = QtGui.QMovie("../../Extara Gui/ExtraGui/initial.gif")
        self.ui.GUI.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("../../Extara Gui/ExtraGui/Earth_Template.gif")
        self.ui.GUI_3.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("../../Voive R/VoiceReg/__1.gif")
        self.ui.RecodGUI.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("../../../Downloads/O1SC.gif")
        self.ui.GUI_6.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("../../Extara Gui/ExtraGui/live.gif")
        self.ui.GUI_IRON_MAN_2.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("../../Extara Gui/ExtraGui/Hero_Template.gif")
        self.ui.GUI_7.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("../../Extara Gui/ExtraGui/B.G_Template_1.gif")
        self.ui.GUI_4.setMovie(self.ui.movie)
        self.ui.movie.start()
        timer=QTimer(self)
        timer=QTimer(self)
    ...
    def showTime(self):
        ...
        self.ui.Text_Temp.setText(f"curent temp {temp}")
